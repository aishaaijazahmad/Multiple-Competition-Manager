package trial;
/**
 * Dated: 23/10/2018 This is Aisha's Competitor Class. It is used to access
 * different data of the Competitor. It contains all basic details of the
 * Competitor and also returns specific calculations regarding their overall
 * attributes.
 * 
...
public class Aisha_Competitor extends Super_Competitor {
	 ...
	 */
	public Aisha_Competitor(int compNum, Name compName, String compLevel, String compPosition, int compAge,
			char compGender) {
		super(compNum, compName, compLevel);
	...
	/**
	 * The method sets the compPosition to the String value newPosition taken from
	 * the user.
	 * 
	...
	/**
	 * The method sets the compGender to the character value newGender taken from
	 * the user.
	 * 
	 ...
	 * Score 1: Leadership and Team work (out of 10) Score 2: Ball Handling
	 * Score(out of 20) Score 3: Offense Score (out of 30) Score 4: Defense Score
	 * (out of 30) Score 5: Tricks and Free style (10) This gives a maximum total of
	 * 100 points which are weighted separately. The total is multiplied by a Level
	 * Bonus score which increases the score based on Level. The Level is awarded to
	 * the Competitor based on their experience and overall skill.
	 * 
	...
	public double getOverallScore() // method to get overall score
	{
		...
		int Level = Integer.parseInt(compLevel);
		switch (Level) {
		case 1:
			level_bonus = 1.20;
			break;
	...
	/**
	 * This method adds scores to the Competitor's Score array directly from the
	 * main function. This option is added in case the user does not have any scores
	 * yet.
	 * 
	...
	public int[] getScoreArray() {
		//int[] arr = new int[5];
		String arr_s = convertScoresToRange();
		String scores[] = arr_s.split(" "); // 6th element is cScores
		int[] cScores;
	...
	/**This method converts scores to range
	 * @return report
	 */
	public String convertScoresToRange() {
		...
		int level = Integer.parseInt(this.getLevel());
		// modify scores based on experience level.
		switch (level) {
		case 1:
			level_bonus = 1.2; // xp level 1
			break;
		case 2:
			level_bonus = 1.4; // xp level 2
			break;
		case 3:
			level_bonus = 1.6; // xp level 3
			break;
		case 4:
			level_bonus = 1.8; // xp level 4
			break;
		case 5:
			level_bonus = 2.0; // xp level 5
			break;
		default:
	...
	public String getFullDetails() // method to get full details
	{
		...
		fullDetails = "\nFull Details: \nCompetitor Number " + compNum + ", name " + compName.getFullName()
				+ ", of level " + compLevel + ", plays at position " + compPosition + ".\n";

		scoreInfo = compName.getFirstName() + ", aged " + compAge + ", recieved the following scores: "
				+ this.convertScoresToRange();

		if (compGender == 'F') {
			overallScoreVal = "\nThis gives her an overall score of: " + String.format("%1.3f", getOverallScore())
					+ ".";
		} else {
			overallScoreVal = "\nThis gives him an overall score of: " + String.format("%1.3f", getOverallScore())
					+ ".";
		}
